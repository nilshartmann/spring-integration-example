...
import nh.examples.springintegration.order.queries.FindAllLineItemsQuery;
import nh.examples.springintegration.order.queries.FindAllOrdersQuery;
import nh.examples.springintegration.order.queries.FindByCustomerAndEmail;
import nh.examples.springintegration.order.queries.FindByCustomerQuery;
