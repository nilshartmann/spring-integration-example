...
import nh.examples.springintegration.order.client.addorder.AddOrderDialog;
import nh.examples.springintegration.order.client.orderdetail.OrderDetailDialog;
